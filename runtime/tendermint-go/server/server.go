...
import (
	...
	pb "github.com/KYVENetwork/kyve-rdk/runtime/tendermint-go/proto/kyverdk/runtime/v1"
	"github.com/KYVENetwork/kyve-rdk/runtime/tendermint-go/utils"
...
func (t *TendermintGoServer) GetRuntimeVersion(ctx context.Context, req *pb.GetRuntimeVersionRequest) (*pb.GetRuntimeVersionResponse, error) {
	return &pb.GetRuntimeVersionResponse{Version: "1.1.5"}, nil
}
